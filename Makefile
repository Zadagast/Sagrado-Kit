...
smoke: engine/smoke_test.cpp engine/hap_test.cpp engine/emoji_text_test.cpp engine/list_view_test.cpp engine/aa_text_test.cpp apps/textedit/smoke_paint.cpp apps/jabber/smoke_paint.cpp engine/*.h | $(BUILD)
	...
	# Kit smooth-text face (metrics, coverage blending, bitmap fallback)
	g++ -std=c++17 -O2 -Wall -Wextra -Iengine engine/aa_text_test.cpp \
	  -o $(BUILD)/aa_text_test
	$(BUILD)/aa_text_test
