...
| Feature discovery | XEP-0030 Service Discovery | 🟡 we query disco; must also *answer* disco#info |
| Feature broadcasts | XEP-0115 Entity Capabilities | ❌ no caps element / ver hash |
...
| Group Chat | XEP-0249 Direct MUC Invitations | ❌ (mediated invites only) |
...
| Advanced Group Chat | XEP-0410 MUC Self-Ping | ❌ (needs XEP-0199 ping) |
...
| XEP-0392 Consistent Color Generation | 🟡 nick colors, not XEP-0392 algorithm |
...
1. **Wave A — required client-level, small:** XEP-0245 /me; XEP-0030 answering
   disco#info; XEP-0115 caps (ver hash); XEP-0199 ping; XEP-0249 direct
   invites (send + receive); XEP-0066 OOB on HTTP uploads.
2. **Wave B — advanced, medium:** XEP-0308 last-message correction (UI: ↑ edit,
   ...
   0153 fallback; XEP-0410 MUC self-ping keepalive; XEP-0392 color algorithm;
